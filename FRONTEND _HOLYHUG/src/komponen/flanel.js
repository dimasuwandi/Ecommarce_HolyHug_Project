...
class Flanel extends Component {
  constructor(){
    super();
    this.state = {
      dataProduk : [],
    ...
    this.handleClick = this.handleClick.bind(this);
      ...
      componentWillMount(){
        axios.get('http://localhost:8000/flanel')
        .then((ambilData) => {
          this.setState({
      ...
      oldest(){
        axios.get('http://localhost:8000/flanelNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/flanelCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/flanelExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
