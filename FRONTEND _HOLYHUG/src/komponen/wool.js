...
class Wool extends Component {
  constructor(){
    ...
    this.handleClick = this.handleClick.bind(this);
      ...
      componentWillMount(){
        axios.get('http://localhost:8000/wool')
        .then((ambilData) => {
          this.setState({
      ...
      oldest(){
        axios.get('http://localhost:8000/woolNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/woolCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/woolExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
