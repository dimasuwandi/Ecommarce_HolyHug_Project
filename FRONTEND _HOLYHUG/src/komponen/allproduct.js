...
class Allproduct extends Component {
    constructor(){
      ...
      oldest(){
        axios.get('http://localhost:8000/allproductNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/allproductCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/allproductExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
