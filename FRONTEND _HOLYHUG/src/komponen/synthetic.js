...
class Synthetic extends Component {
  constructor(){
    ...
    this.handleClick = this.handleClick.bind(this);
      ...
      oldest(){
        axios.get('http://localhost:8000/syntheticNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/syntheticCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/syntheticExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
