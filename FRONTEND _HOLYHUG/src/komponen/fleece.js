...
class Fleece extends Component {
    constructor(){
        super();
        this.state = {
          dataProduk : [],
      ...
      componentWillMount(){
        axios.get('http://localhost:8000/fleece')
        .then((ambilData) => {
          this.setState({
      ...
      oldest(){
        axios.get('http://localhost:8000/fleeceNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/fleeceCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/fleeceExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
