...
class Feather extends Component {
  constructor(){
    ...
    this.handleClick = this.handleClick.bind(this);
      ...
      componentWillMount(){
        axios.get('http://localhost:8000/feather')
        .then((ambilData) => {
          this.setState({
      ...
      oldest(){
        axios.get('http://localhost:8000/featherNewest')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      cheap(){
        axios.get('http://localhost:8000/featherCheap')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
      ...
      expensive(){
        axios.get('http://localhost:8000/featherExpensive')
        .then((ambilData) => {
          this.setState({
            dataProduk: ambilData.data
          })
